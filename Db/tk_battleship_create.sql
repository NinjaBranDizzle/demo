...
(
  ...
  AIR_ATTACK       INT         NOT NULL DEFAULT 0,
  AIR_DEFENCE      INT         NOT NULL DEFAULT 0,
  GROUND_ATTACK    INT         NOT NULL DEFAULT 0,
  GROUND_DEFENCE   INT         NOT NULL DEFAULT 0,
  ATTACK_RANGE     INT         NOT NULL DEFAULT 0,
  MOVE_RANGE       INT         NOT NULL DEFAULT 0,
/*
  PARENT_STRUCTURE VARCHAR(32) NOT NULL DEFAULT "",
  CAN_FLY          INT         NOT NULL DEFAULT 0,
  CAN_DRIVE        INT         NOT NULL DEFAULT 0,
*/
  HAS_SUPER_POWER  INT         NOT NULL DEFAULT 0
);
